...
SOURCES = {
    ...
    "world-map": {
        ...
        # Static source — not a gov.uk publication or live API.  The data
        # file is regenerated by build_world_map.py from a locally cached
        # GeoJSON; the cache is committed (not gitignored) because the
        # upstream source is version-stable at 110m resolution.
        "landing_url": "https://www.naturalearthdata.com/downloads/110m-cultural-vectors/",
        "filename_stem": None,
        "fetcher": None,          # no network fetch — source is static cache
        "builder": "scripts/build_world_map.py",
        "data_file": "data/world-map-data.js",
        "data_globals": ("WORLD_MAP",),
    },
}
